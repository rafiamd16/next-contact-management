...
import { signInSocialAction, signUpAction } from '@/lib/actions/auth-action'
import { signUpSchema, type SignUpInputSchema } from '@/lib/validations/auth-validation'
import { zodResolver } from '@hookform/resolvers/zod'
import Link from 'next/link'
import { Activity, useState, useTransition } from 'react'
import { Controller, useForm } from 'react-hook-form'
import { FaCheckDouble, FaGithub, FaGoogle, FaIdCard, FaUserPlus } from 'react-icons/fa'
...
const SignUpForm = () => {
  ...
  const onSubmit = async (values: SignUpInputSchema) => {
    setGlobalError(null)
    ...
    <div className='space-y-4 w-xs '>
      ...
      <form
        ...
        <Button
          ...
          {isPending ? <Spinner className='size-4' /> : <FaUserPlus />}
      ...
      <p className='text-center text-sm text-muted-foreground'>
        ...
        <Link href='/sign-in' className='underline underline-offset-4 font-bold transition-all'>
          Sign in
        </Link>
      </p>
    </div>
